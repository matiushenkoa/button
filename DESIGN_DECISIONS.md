...
```typescript
// Public exports from design-system/index.ts
...
export { SpinnerIcon, PlusIcon, ArrowIcon } from './design-system/icons';
export { ThemeProvider, useTheme } from './design-system/theme';
export type { Theme, ThemeContextType } from './design-system/theme';
```
...
The full list of available tokens is defined in `src/design-system/theme/theme.scss` and `src/design-system/tokens/`.
